...
export default function EditBlogPost({ params }: { params: { slug: string } }) {
  ...
  // Handle title change and auto-generate slug if slug is empty or matches the original slug
  const handleTitleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const newTitle = e.target.value;
    setTitle(newTitle);
    
    // Slug değiştirilmemişse otomatik güncelle
    if (newSlug === slug) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Güncellenmiş blog yazısı verisi
      const updatedPost = {
        title,
        slug: newSlug,
        content,
      ...
      console.error('Blog yazısı güncellenirken hata oluştu:', err);
    } finally {
      setLoading(false);
    }
  };
  ...
  // Yükleniyor durumunda loading spinner göster
  if (fetchLoading) {
    return (
  ...
  return (
    <div>
      <div className="pb-5 border-b border-gray-200 sm:flex sm:items-center sm:justify-between">
        <h3 className="text-lg leading-6 font-medium text-gray-900">Blog Yazısını Düzenle</h3>
      ...
      <div className="mt-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            ...
            {image && (
              <div className="sm:col-span-6">
                <h4 className="text-sm font-medium text-gray-700 mb-3">Mevcut Görsel</h4>
                <div className="relative w-64">
                  <img
                    src={image}
                    alt={imageAlt || 'Blog görseli'}
            ...
            {newImages.length > 0 && (
              <div className="sm:col-span-6">
                <h4 className="text-sm font-medium text-gray-700 mb-3">Yüklenen Yeni Görseller</h4>
