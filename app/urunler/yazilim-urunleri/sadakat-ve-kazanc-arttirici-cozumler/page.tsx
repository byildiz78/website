  ...
  return (
    <div className="min-h-screen">
      ...
      <PageHero
        ...
        subtitle="Müşteri bağlılığını artırarak işletmenizin kazancını yükseltin"
        backgroundImage="/images/sadakat/sadakat-dashboard.png"
      >
        <motion.div
      ...
      </PageHero>{/* Main Description Section */}
