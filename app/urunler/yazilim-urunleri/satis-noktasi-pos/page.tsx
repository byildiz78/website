    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[300px] flex items-center overflow-hidden">
        ...
        >
          <div className="absolute inset-0 flex items-center justify-center">
            <video
              src="/images/pos-screen/air-main-screen.webm"
              autoPlay
              loop
              muted
              playsInline
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              robotPOS, işletmenizin ihtiyaçlarına göre özelleştirilebilen, kullanıcı dostu ve güçlü bir satış yönetim sistemidir.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -inset-4 bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-xl blur-lg"></div>
              ...
              <div className="absolute -bottom-2 -right-2 bg-blue-600 text-white py-2 px-4 rounded-lg shadow-lg">
                <p className="text-sm font-medium">Modern ve Kullanıcı Dostu Arayüz</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-6 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl font-bold mb-3">
              Eksiksiz <span className="text-blue-600">Ekosistem</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              robotPOS, işletmenizin tüm ihtiyaçlarını karşılayan entegre bir ekosistem sunar.
            </p>
          </motion.div>
          <Image
